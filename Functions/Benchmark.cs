...
namespace Functions
{
    ...
    {
        internal BenchmarkResult Run(IDataGenerator dataGenerator, IHashFunction hashFunction, long modulo)
        {
        ...
        private BenchmarkResult CreateResult(TimeSpan time, List<KeyValuePair<long, long>> mappedValues, long modulo, IHashFunction hashFunction)
        {
